...
Then we create and set values for landcover rasters based on landcover2 values of Habitat classification variables
...
writeRaster(all_rasters,"Output/lab6Stack.tif",names = 'names')
```
